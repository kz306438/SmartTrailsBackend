...
const std::vector<typename Users::MetaData> Users::metaData_ = {
    ...
    {"role", "std::string", "character varying", 10, 0, 0, 1},
...
Users::Users(const Json::Value&              pJson,
...
{
    static const std::vector<std::string> inCols = {"username", "email", "password_hash", "role",
                                                    "created_at"};
    return inCols;
}
...
bool Users::validJsonOfField(size_t index, const std::string& fieldName, const Json::Value& pJson,
