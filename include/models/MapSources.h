...
class MapSources
{
  public:
     ...
     */
    explicit MapSources(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit MapSources(const Json::Value &pJson) noexcept(false);
     ...
     */
    MapSources(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<MapSources>;
    friend drogon::orm::BaseBuilder<MapSources, true, true>;
    friend drogon::orm::BaseBuilder<MapSources, true, false>;
    friend drogon::orm::BaseBuilder<MapSources, false, true>;
    friend drogon::orm::BaseBuilder<MapSources, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<MapSources>;
#endif
